...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://techtransistor-b855a.firebaseio.com/"),
    refCart = new Firebase("https://techtransistor-b855a.firebaseio.com/cart"),
    refUser = new Firebase("https://techtransistor-b855a.firebaseio.com/users"),
    refCategory = new Firebase("https://techtransistor-b855a.firebaseio.com/category"),
    refOrder = new Firebase("https://techtransistor-b855a.firebaseio.com/orders"),
    refFeatured = new Firebase("https://techtransistor-b855a.firebaseio.com/featured"),
    refMenu = new Firebase("https://techtransistor-b855a.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
